...
import google.generativeai as genai  # <-- THIS IS THE FIX
...
API_KEY = "AIzaSyCopL6EX2OCR2mnj1ottpVWiiY4WFD_Q-4" 
...
def load_data():
    ...
    webnlg_data = []
    dataset = dataset[20000:]  # For testing, process only a subset (remove or adjust as needed)
